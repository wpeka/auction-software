...
<?php echo sprintf( esc_html__( "You've been outbid in the %1\$s auction. %2\$s to place your next bid.", 'auction-software' ), esc_attr( $product_data->get_title() ), sprintf( "<a href='%s' target='_blank'>Click here</a>", esc_url( get_permalink( $product_id ) ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	<br><br>
