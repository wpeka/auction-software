<?php
/**
 * Admin auction end email.
 *
 * This template can be overridden by copying it to yourtheme/auction-software/woocommerce/emails/auction-software-end.php
 *
...
<?php echo sprintf( esc_html__( 'The %s auction has ended.', 'auction-software' ), esc_attr( $product_data->get_title() ) ); ?>
	<br><br>
