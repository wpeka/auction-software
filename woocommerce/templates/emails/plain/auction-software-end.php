<?php
/**
 * Admin auction end email (plain text).
 *
 * This template can be overridden by copying it to yourtheme/auction-software/woocommerce/emails/plain/auction-software-end.php
 *
