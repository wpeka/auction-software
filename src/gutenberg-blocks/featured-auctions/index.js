...
registerBlockType("auction-software/featured-auctions", {
    title: __("Auction Software Featured Auctions", "auction-software"),
    ...
    edit(props) {
        ...
        return props.isSelected ? (<div>
			...
			<p>{__('Auction Software Featured Auctions Widget', 'auction-software')}</p>
		</div>);
    },
