...
registerBlockType("auction-software/recent-auctions", {
    title: __("Auction Software Recent Auctions", "auction-software"),
    description: __("Shows the list of recent auctions", "auction-software"),
    icon: "flag",
    ...
    edit(props) {
        ...
        return props.isSelected ? (<div>
			...
			<p>{__('Auction Software Recent Auctions Widget', 'auction-software')}</p>
		</div>);
    },
