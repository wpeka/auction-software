...
registerBlockType("auction-software/random-auctions", {
    title: __("Auction Software Random Auctions", "auction-software"),
    description: __("Shows the list of random auctions", "auction-software"),
    icon: "flag",
    ...
    edit(props) {
        ...
        return props.isSelected ? (<div>
			...
			<p>{__('Auction Software Random Auctions Widget', 'auction-software')}</p>
		</div>);
    },
