 ...
 * @subpackage Auction_Software/wcfm
 */
 ...
 * @subpackage Auction_Software/wcfm
 */
class WCFM_Auction_Software_Helper {
	...
	public static function get_product_tab_fields( $input_type, $id, $label, $desc_tip, $description, $currency = false, $options = '', $custom_attributes = array(), $class = '', $wrapper_class = '' ) {
		switch ( $input_type ) {
			case 'text':
				if ( ( 'date_from' === $id || 'date_to' === $id ) ) {
					return array(
						'auction_' . $id => array(
							...
							'class'             => 'wcfm-text wcfm_ele auction_simple auction_reverse auction_penny' . $class,
							'wrapper_class'     => $wrapper_class,
							'desc_tip'          => $desc_tip,
							'description'       => $description,
						),
					);
				} elseif ( ( 'reserve_price' === $id || 'buy_it_now_price' === $id ) ) {
					return array(
						'auction_' . $id =>
						array(
							'label'             => self::get_id_title( $id, $label, $currency ),
							'label_class'       => 'wcfm_title wcfm_ele auction_simple',
							'custom_attributes' => $custom_attributes,
							'class'             => 'wcfm-text wcfm_ele auction_simple' . $class,
							'wrapper_class'     => $wrapper_class,
							'type'              => 'text',
							'desc_tip'          => $desc_tip,
							'description'       => $description,
				...
				} elseif ( ( 'reserve_price_reverse' === $id || 'buy_it_now_price_reverse' === $id ) ) {
					return array(
						'auction_' . $id =>
						array(
							'label'             => self::get_id_title( $id, $label, $currency ),
							'label_class'       => 'wcfm_title wcfm_ele auction_reverse',
							'custom_attributes' => $custom_attributes,
							'class'             => 'wcfm-text wcfm_ele auction_reverse' . $class,
							'wrapper_class'     => $wrapper_class,
							'type'              => 'text',
							'desc_tip'          => $desc_tip,
							'description'       => $description,
					...
					return array(
						...
						array(
							'label'             => self::get_id_title( $id, $label, $currency ),
							'label_class'       => $wrapper_class . 'wcfm_title',
							'custom_attributes' => $custom_attributes,
							'class'             => $wrapper_class . 'wcfm-text wcfm_ele auction_simple auction_reverse auction_penny' . $class,
							'wrapper_class'     => $wrapper_class,
							'type'              => 'text',
							'desc_tip'          => $desc_tip,
							'description'       => $description,
			...
			case 'select':
				...
				return array(
					'auction_' . $id => array(
						...
						'custom_attributes' => $custom_attributes,
						'class'             => $wrapper_class . 'wcfm-select wcfm_ele auction_simple auction_reverse auction_penny' . $class,
						'wrapper_class'     => $wrapper_class,
						'desc_tip'          => $desc_tip,
						'description'       => $description,
					),
			...
			case 'checkbox':
				return array(
					...
					array(
						'label'         => self::get_id_title( $id, $label, $currency ),
						'label_class'   => $wrapper_class . 'wcfm_title wcfm-checkbox',
						'class'         => $wrapper_class . 'wcfm-checkbox wcfm_ele auction_simple auction_reverse auction_penny' . $class,
						'wrapper_class' => $wrapper_class,
						'desc_tip'      => $desc_tip,
						'description'   => $description,
						'type'          => 'checkbox',
