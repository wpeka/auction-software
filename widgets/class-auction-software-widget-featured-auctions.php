 ...
 */
class Auction_Software_Widget_Featured_Auctions extends WP_Widget {
	...
	/**
	 * Auction_Software_Widget_Featured_Auctions constructor.
	 */
	public function __construct() {

		// Widget variable settings.
		$this->auctionwidget_cssclass    = 'woocommerce widget_featured_auctions';
		$this->auctionwidget_description = __( 'Display a list of featured auctions on your site.', 'auction-software' );
		$this->auctionwidget_idbase      = 'featured_auctions';
		$this->auctionwidget_name        = __( 'Auction Software Featured Auction', 'auction-software' );
	...
	public function widget( $args, $instance ) {
		...
		$title  = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Featured Auctions', 'auction-software' ) : $instance['title'], $instance, $this->id_base );
		$number = 5;
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['widget_featured_auctions'] ) ) {
			delete_option( 'widget_featured_auctions' );
		}
	...
	public function form( $instance ) {
		$title     = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Featured Auctions', 'auction-software' );
		$hide_time = empty( $instance['hide_time'] ) ? 0 : 1;
