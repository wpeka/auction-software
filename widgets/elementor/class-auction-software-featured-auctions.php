...
class Auction_Software_Featured_Auctions extends \Elementor\Widget_Base {
	 ...
	 * Get widget name.
	 *
	 * Retrieve Widget_Featured widget name.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 * Get widget title.
	 *
	 * Retrieve Widget_Featured widget title.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_title() {
		return __( 'Auction Software Featured Auctions', 'auction-software' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Widget_Featured widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Retrieve the list of categories the Widget_Featured widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	/**
	 * Register Widget_Featured widget controls.
	 *
	...
	/**
	 * Render Widget_Featured widget output on the frontend.
	 *
	...
	protected function render() {
		...
		$title      = sprintf( $settings['widget_featured_title'], 'auction-software' );
			$number = 5;
