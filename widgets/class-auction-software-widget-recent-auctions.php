 ...
 */
class Auction_Software_Widget_Recent_Auctions extends WP_Widget {
	...
	/**
	 * Auction_Software_Widget_Recent_Auctions constructor.
	 */
	public function __construct() {

		// Widget variable settings.
		$this->auctionwidget_cssclass    = 'woocommerce widget_recent_auctions';
		$this->auctionwidget_description = __( 'Display a list of most recent auctions on your site.', 'auction-software' );
		$this->auctionwidget_idbase      = 'recent_auctions';
		$this->auctionwidget_name        = __( 'Auction Software Recent Auctions', 'auction-software' );
	...
	public function widget( $args, $instance ) {
		...
		$title  = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Recent Auctions', 'auction-software' ) : $instance['title'], $instance, $this->id_base );
		$number = 5;
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['widget_recent_auctions'] ) ) {
			delete_option( 'widget_recent_auctions' );
		}
	...
	public function form( $instance ) {
		$title = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Recent Auctions', 'auction-software' );
