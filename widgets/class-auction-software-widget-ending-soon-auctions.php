<?php
/**
 * The widget-specific functionality for ending soon auctions.
 *
 ...
 */
class Auction_Software_Widget_Ending_Soon_Auctions extends WP_Widget {
	...
	/**
	 * Auction_Software_Widget_Ending_Soon_Auctions constructor.
	 *
	 * @since 1.0.0
	 */
	public function __construct() {
		// Widget variable settings.
		$this->auctionwidget_cssclass    = 'woocommerce widget_ending_soon_auctions';
		$this->auctionwidget_description = __( 'Display a list of ending soon auctions on your site.', 'auction-software' );
		$this->auctionwidget_idbase      = 'ending_soon_auctions';
		$this->auctionwidget_name        = __( 'Auction Software Ending Soon Auctions', 'auction-software' );
	...
	public function widget( $args, $instance ) {
		...
		$title  = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Ending Soon Auctions', 'auction-software' ) : $instance['title'], $instance, $this->id_base );
		$number = 5;
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['widget_ending_soon_auctions'] ) ) {
			delete_option( 'widget_ending_soon_auctions' );
		}
	...
	public function form( $instance ) {
		$title = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Ending Soon Auctions', 'auction-software' );
