 ...
 */
class Auction_Software_Widget_Future_Auctions extends WP_Widget {
	...
	/**
	 * Auction_Software_Widget_Future_Auctions constructor.
	 *
	 * @since 1.0.0
	 */
	public function __construct() {
		...
		$this->auctionwidget_cssclass    = 'woocommerce widget_future_auctions';
		$this->auctionwidget_description = __( 'Display a list of coming soon auctions on your site.', 'auction-software' );
		$this->auctionwidget_idbase      = 'future_auctions';
		$this->auctionwidget_name        = __( 'Auction Software Coming Soon Auctions', 'auction-software' );
	...
	public function widget( $args, $instance ) {
		...
		$title  = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Coming Soon Auctions', 'auction-software' ) : $instance['title'], $instance, $this->id_base );
		$number = 5;
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['widget_future_auctions'] ) ) {
			delete_option( 'widget_future_auctions' );
		}
	...
	public function form( $instance ) {
		$title = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Coming Soon Auctions', 'auction-software' );
